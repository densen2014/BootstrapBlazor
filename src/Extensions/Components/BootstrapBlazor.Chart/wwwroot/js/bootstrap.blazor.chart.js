(function ($) {
    ...
    $.extend({
        getChartOption: function (option, obj) {
            var colors = [];
        ...
        chart: function (el, obj, method, option, updateMethod, type, angle) {
            if ($.isFunction(Chart)) {
                ...
                if (!chart) {
                    var op = $.getChartOption(option, obj);
